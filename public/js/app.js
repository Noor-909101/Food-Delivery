...
var time = document.createElement('small'); //update status 
...
updateStatus(order); //payment stripe 
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51K9xIdSFwskz53XfJ7MEYGiTUQ3YGaF1H2G3eMwA5x0xrk9UvagWk2tKM2V3zgKVwSKrMpxjWxYTPKo2VXwdZMTp00JuLz8Xwu');
